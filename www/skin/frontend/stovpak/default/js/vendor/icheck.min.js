...
B;if(!c[r]){if("click"==d)F(a,!1,!0);else{if(/wn|er|in/.test(d))h[v](e);else h[z](e+" "+w);if(m.length&&y&&e==B)m[/ut|nd/.test(d)?z:v](C)}if(J)b.stopPropagation();else return!1}})})}})(window.jQuery||window.Zepto);
