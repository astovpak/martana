 ...
 */
class Stovpak_Article_Model_Resource_Article_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
     ...
     * @return Stovpak_Article_Model_Resource_Article_Collection
     * @author Ultimate Module Creator
     */
    ...
    protected function _renderFiltersBefore()
    {
        if ($this->getFilter('store')) {
            $this->getSelect()->join(
                array('store_table' => $this->getTable('stovpak_article/article_store')),
