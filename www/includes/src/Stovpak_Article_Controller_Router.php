 ...
 */
class Stovpak_Article_Controller_Router extends Mage_Core_Controller_Varien_Router_Abstract
{
    /**
     * init routes
     *
     ...
     * @return Stovpak_Article_Controller_Router
     * @author Ultimate Module Creator
     */
    public function initControllerRouters($observer)
    {
        $front = $observer->getEvent()->getFront();
        $front->addRouter('stovpak_article', $this);
        return $this;
    }
    ...
    public function match(Zend_Controller_Request_Http $request)
    {
        ...
        $check['article'] = new Varien_Object(
            array(
                'prefix'        => Mage::getStoreConfig('stovpak_article/article/url_prefix'),
                'suffix'        => Mage::getStoreConfig('stovpak_article/article/url_suffix'),
                'list_key'      => Mage::getStoreConfig('stovpak_article/article/url_rewrite_list'),
                'list_action'   => 'index',
                'model'         =>'stovpak_article/article',
                'controller'    => 'article',
                'action'        => 'view',
                'param'         => 'id',
                'check_path'    => 0
