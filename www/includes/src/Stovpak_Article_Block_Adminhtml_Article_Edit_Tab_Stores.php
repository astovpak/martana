 ...
 */
class Stovpak_Article_Block_Adminhtml_Article_Edit_Tab_Stores extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * prepare the form
     *
     * @access protected
     * @return Stovpak_Article_Block_Adminhtml_Article_Edit_Tab_Stores
     * @author Ultimate Module Creator
     */
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset(
            'article_stores_form',
            array('legend' => Mage::helper('stovpak_article')->__('Store views'))
        );
